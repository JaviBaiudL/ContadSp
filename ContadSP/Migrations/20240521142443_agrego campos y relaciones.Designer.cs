...
namespace ContadSP.Migrations
{
    ...
    [Migration("20240521142443_agrego campos y relaciones")]
    partial class agregocamposyrelaciones
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContadSP.Models.Pedido", b =>
                {
                    ...
                    b.Property<int>("proceso_pedido_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContadSP.Models.Pedido", b =>
                {
                    b.HasOne("ContadSP.Models.ProcesoPedido", "ProcesoPedido")
                        .WithMany("Pedido")
                        .HasForeignKey("proceso_pedido_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
